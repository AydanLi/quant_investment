...
experiment_runs = Table(
    ...
    Column("dataset_snapshot_id", Integer, ForeignKey("dataset_snapshots.id")),
    Column("universe_version", String(40), ForeignKey("universe_versions.version")),
...
dataset_snapshots = Table(
    ...
    Column("decision_set_hash", String(64)),
...
data_quality_decisions = Table(
    ...
    Column("issue_code", String(60), nullable=False),
    Column("ticker", String(20), nullable=False),
    Column("start_date", String(20), nullable=False),
    Column("end_date", String(20), nullable=False),
    Column("raw_data_hash", String(64), nullable=False),
    Column("disposition", String(40), nullable=False),
    Column("normalization_json", JSON, nullable=False),
    ...
    UniqueConstraint(
        "source_snapshot_id",
        "issue_fingerprint",
        name="uq_data_quality_decisions_snapshot_issue",
    ),
    Index(
        "ix_data_quality_decisions_snapshot_ticker_dates",
        "source_snapshot_id",
        "ticker",
        "start_date",
        "end_date",
...
strategy_versions = Table(
    ...
    Column(
        "universe_version",
        String(40),
        ForeignKey("universe_versions.version"),
        nullable=False,
    ),
    Column(
        "dataset_snapshot_id",
...
admission_runs = Table(
    ...
    Column(
        "strategy_version",
        String(40),
        ForeignKey("strategy_versions.version", ondelete="CASCADE"),
        nullable=False,
    ),
    Column("created_at", DateTime, nullable=False, server_default=func.now()),
...
parameter_trials = Table(
    ...
    Column("stage", String(30), nullable=False, server_default="final"),
    Column("fold_key", String(100), nullable=False, server_default="ALL"),
    ...
    UniqueConstraint(
        ...
        "fold_key",
        "label",
        name="uq_parameter_trials_admission_stage_fold_label",
    ),
)
...
signal_decisions = Table(
    ...
    Column(
        "strategy_version",
        String(40),
        ForeignKey("strategy_versions.version"),
        nullable=False,
    ),
    Column(
        "universe_version",
    ...
    Column("signal_session", String(20), nullable=False),
    Column("data_as_of", String(40), nullable=False),
    Column("generated_at", DateTime, nullable=False),
    Column("next_rebalance_session", String(20), nullable=False),
    Column("status", String(20), nullable=False),
    ...
    UniqueConstraint(
        ...
        "strategy_version",
        "signal_session",
        name="uq_signal_decisions_environment_strategy_session",
    ),
)
...
paper_cycles = Table(
    ...
    Column("signal_session", String(20), nullable=False),
    Column("execution_session", String(20), nullable=False),
    ...
    UniqueConstraint(
        ...
        "strategy_version",
        "signal_session",
        name="uq_paper_cycles_environment_strategy_session",
    ),
)
...
paper_accounts = Table(
    ...
    Column("settled_cash", Float, nullable=False),
    Column("available_cash", Float, nullable=False),
...
paper_cash_movements = Table(
    ...
    metadata,
    Column("id", Integer, primary_key=True),
    Column("movement_key", String(100), nullable=False, unique=True),
    Column(
        "account_id",
        Integer,
    ...
    Column("order_intent_id", Integer, ForeignKey("order_intents.id")),
    Column("amount", Float, nullable=False),
    Column("trade_date", String(20), nullable=False),
    Column("settlement_date", String(20), nullable=False),
    Column("status", String(20), nullable=False, server_default="PENDING"),
    Column("created_at", DateTime, nullable=False, server_default=func.now()),
    Column("settled_at", DateTime),
    Index("ix_paper_cash_movements_account_settlement", "account_id", "settlement_date"),
)
...
order_intents = Table(
    ...
    Column("signal_decision_id", Integer, ForeignKey("signal_decisions.id")),
    Column("paper_cycle_id", Integer, ForeignKey("paper_cycles.id")),
    Column("created_at", DateTime, nullable=False, server_default=func.now()),
    Column("approved_at", DateTime),
    Column("approved_by", String(100)),
    Column("status", String(20), nullable=False),
    ...
    Column("order_type", String(20), nullable=False, server_default="LMT"),
    Column("execution_session", String(20)),
...
execution_fills = Table(
    ...
    Column("settlement_date", String(20)),
...
risk_incidents = Table(
    ...
    Column("environment", String(20), nullable=False, server_default="PAPER"),
    Column("account_ref", String(80)),
    Column("paper_cycle_id", Integer, ForeignKey("paper_cycles.id")),
    Column("reconciliation_id", Integer, ForeignKey("reconciliations.id")),
    Column("order_intent_id", Integer, ForeignKey("order_intents.id")),
    ...
    Column("recovery_authorized_by", String(100)),
    Column("recovery_authorized_at", DateTime),
    Column("notification_status", String(20), nullable=False, server_default="PENDING"),
    Column("notification_request_id", String(100)),
    Column("notification_attempts", Integer, nullable=False, server_default="0"),
    Column("notification_last_error", String),
)
