...
# Resolve the database URL from the application config (env var override
# allowed) rather than hardcoding it in alembic.ini, so migrations always
# target the same database the app uses.
_db_url = os.environ.get("QUANT_DB_URL") or Config().db_url
...
# Schema metadata for 'autogenerate' support.
target_metadata = metadata

# SQLite cannot ALTER most columns in place; batch mode rewrites the table.
# Harmless on Postgres/MySQL, essential for SQLite migrations.
